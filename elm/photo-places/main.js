...
var _user$project$Main$photoElement = function (url) {
	return _evancz$elm_graphics$Element$toHtml(
		A3(_evancz$elm_graphics$Element$image, 1000, 1000, url));
};
var _user$project$Main$suggestionDisplay = function (suggs) {
	var listItems = A2(
		_elm_lang$core$List$map,
		function (s) {
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(s.description),
					_1: {ctor: '[]'}
				});
		},
		suggs);
...
var _user$project$Main$apiKey = 'AIzaSyCKorHiV5ltM3pHvcyPCFrEfh05tTag98Y';
var _user$project$Main$placesAutoCompleteURL = function (input) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		...
		A2(
			_elm_lang$core$Basics_ops['++'],
			input,
			A2(_elm_lang$core$Basics_ops['++'], '&key=', _user$project$Main$apiKey)));
};
var _user$project$Main$photoUrl = _elm_lang$core$Native_Platform.incomingPort('photoUrl', _elm_lang$core$Json_Decode$string);
var _user$project$Main$placeInput = _elm_lang$core$Native_Platform.outgoingPort(
	'placeInput',
	function (v) {
		return v;
	});
			...
			case 'PlaceInput':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{input: _p1}),
					_1: _user$project$Main$placeInput(_p1)
				};
...
var _user$project$Main$placeSuggestions = _elm_lang$core$Native_Platform.incomingPort(
	'placeSuggestions',
...
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {input: a, suggestions: b, photoUrl: c};
	});
var _user$project$Main$Suggestion = F2(
	function (a, b) {
		return {id: a, description: b};
	});
var _user$project$Main$PhotoUrl = function (a) {
	return {ctor: 'PhotoUrl', _0: a};
};
var _user$project$Main$PlaceSuggestions = function (a) {
	return {ctor: 'PlaceSuggestions', _0: a};
};
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Main$photoUrl(_user$project$Main$PhotoUrl),
			_1: {
				ctor: '::',
				_0: _user$project$Main$placeSuggestions(_user$project$Main$PlaceSuggestions),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Main$PlaceInput = function (a) {
	return {ctor: 'PlaceInput', _0: a};
};
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$PlaceInput),
					_1: {ctor: '[]'}
				},
				{ctor: '[]'}),
			_1: {
				ctor: '::',
				_0: _user$project$Main$suggestionDisplay(model.suggestions),
				_1: {
					ctor: '::',
					_0: _user$project$Main$photoElement(model.photoUrl),
					_1: {ctor: '[]'}
				}
			}
		});
